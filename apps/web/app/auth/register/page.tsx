      ...
      <Card radius="none" shadow="sm" className="w-full max-w-sm p-4">
        <CardHeader className="flex gap-4 flex-col items-start">
          ...
          <p className="text-sm text-gray-500">
            This is a hobby project and is not intended for use with personal
            credentials. While I have implemented security measures, I cannot
            guarantee complete security. <br /> <br />{" "}
            <b>Please use a fake email and password.</b>
          </p>
        </CardHeader>
